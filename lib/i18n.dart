...
const Map<String, String> _zhCN = {
  ...
  'app.about': '关于 Codux',
  'app.aboutText':
      'Codux Mobile 是 Codux 的移动控制端，用于通过 Iroh 安全连接 Mac，远程查看项目分屏、操作终端并管理多台电脑。',
  'app.github': 'GitHub',
  'app.licenses': '协议',
  'app.close': '关闭',
  ...
  'pair.paste': '粘贴',
  'pair.submit': '配对',
  'pair.networkHint': '确保手机与电脑可以访问网络以完成 Iroh 发现和连接',
  ...
  'connection.relay': '中继',
  'connection.protocol.irohQuic': 'QUIC',
  ...
  'upload.directRequired': '文件上传仅支持直连，请切换到直连后重试',
  'upload.aiTool': 'AI 工具',
...
const Map<String, String> _zhTW = {
  ...
  'upload.directRequired': '檔案上傳僅支援直連，請切換到直連後重試',
  'upload.aiTool': 'AI 工具',
  'cmd.hint': '命令（備用輸入）',
};
...
const Map<String, String> _en = {
  ...
  'app.aboutText':
      'Codux Mobile is the mobile companion for Codux. It connects to your Mac through Iroh, controls project terminals, and manages paired computers.',
  'app.github': 'GitHub',
  ...
  'pair.submit': 'Pair',
  'pair.networkHint':
      'Make sure phone and computer can reach the network for Iroh discovery and connection',
  ...
  'upload.directRequired': 'File upload requires a direct connection',
